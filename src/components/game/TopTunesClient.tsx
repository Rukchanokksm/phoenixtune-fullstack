        ...
        {tabs.map((t) => (
          <button
            ...
            style={{
              ...
              boxShadow:
                period === t.key ? "0 0 14px rgba(250,204,21,0.3)" : "none",
            }}
          >
            {t.label}
          </button>
            ...
            return (
              ...
              >
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: "44px 1fr 110px 70px 64px",
                    alignItems: "center",
                    gap: "12px",
                    padding: "14px 18px",
                    background: "#111318",
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "12px", color: "#475569" }}>
                      {tune.car ? `${tune.car.make} ${tune.car.model}` : "—"} ·
                      @{tune.user?.username ?? "anon"}
                    </div>
                  </div>
                  <span
                    style={{
