        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            ...
            <span style={{ color: "#374151", fontSize: "11px" }}>
              {timeAgo(post.updated_at, locale as "en" | "th")}
            </span>
          </div>
        </div>
        <div style={{ display: "flex", gap: "16px", flexShrink: 0 }}>
          <span style={{ color: "#475569", fontSize: "12px" }}>
            {post.comment_count} {t.forums.comments}
          </span>
    ...
    >
      ...
      >
        <div>
          ...
          <span
            style={{ color: "#475569", fontSize: "12px", marginLeft: "10px" }}
          >
            {sub}
          </span>
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        <SegmentCard
          title={f.catAnnouncement}
          sub={f.catAnnouncementSub}
          href="/forums/announcements"
          adminLink={
            isAdmin ? (
              <Link
                href="/forums/new?category=announcement"
                style={{
                  color: "#6366f1",
                  fontSize: "12px",
                  textDecoration: "none",
