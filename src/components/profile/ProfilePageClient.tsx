...
export function ProfilePageClient({
  ...
  return (
    <div
      style={{ maxWidth: "800px", margin: "0 auto", padding: "40px 24px 80px" }}
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        {gameGroups.length === 0 && (
          ...
          >
            <p
              style={{ color: "#475569", fontSize: "14px", margin: "0 0 12px" }}
            >
              {pp.noTunes}
            </p>
            <Link
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ color: "#475569", fontSize: "12px" }}>
                  ({group.tunes.length} tune)
                </span>
              </div>
              <Link
                href={`/tunes?game=${group.gameSlug}&user=${profile.username}`}
                style={{
                  color: "#64748b",
                  fontSize: "12px",
                  textDecoration: "none",
            ...
            >
              {group.tunes.map((tune) => {
                const piColor =
                  PI_COLORS[tune.car?.pi_class ?? ""] ?? "#64748b";
                const isEdited =
                  tune.updated_at &&
                    ...
                    >
                      {tune.car && (
                        <span
                          style={{
                            ...
                            fontWeight: 800,
                            color: piColor,
                            background: piColor + "18",
                            border: `1px solid ${piColor}44`,
                            padding: "2px 7px",
                            borderRadius: "5px",
                            flexShrink: 0,
                          }}
                      ...
                      <span
                        style={{
                          ...
                          fontWeight: 700,
                          flexShrink: 0,
                          color: DISC_COLORS[tune.discipline] ?? "#64748b",
                        }}
                      >
                        {tune.discipline}
                      </span>
                      ...
                      >
                        <span style={{ color: "#374151", fontSize: "11px" }}>
                          {new Date(tune.created_at).toLocaleDateString(
                            dateLocale,
