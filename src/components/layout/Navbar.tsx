    ...
    <nav style={{
      ...
      <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            <div ref={gamesRef} style={{ position: 'relative' }}>
              <button
                ...
                style={{ ...navLinkStyle, display: 'flex', alignItems: 'center', gap: '4px', background: 'none', border: 'none', cursor: 'pointer' }}
              >
                ...
                <div style={{
                  ...
                  {GAMES.map((g) => (
                    <Link
                      ...
                      onMouseEnter={(e) => { if (g.active) (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.06)' }}
            ...
            <Link href="/forums" style={navLinkStyle}>Forums</Link>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '8px' }}>
          {loading ? (
            <div style={{ width: '80px', height: '32px', borderRadius: '8px', background: 'rgba(255,255,255,0.05)' }} />
          ) : user ? (
            /* Logged-in user menu */
            <div ref={userMenuRef} style={{ position: 'relative' }}>
              ...
              >
                {user.avatarUrl ? (
                  <img src={user.avatarUrl} alt={user.username} width={28} height={28}
                    style={{ borderRadius: '50%', objectFit: 'cover' }} />
                ) : (
                  <span style={{ color: '#94a3b8' }}><UserCircleIcon /></span>
                )}
                <span style={{ fontSize: '13.5px', fontWeight: 500 }}>{user.username}</span>
                {user.isPremium && (
                  <span style={{
                    fontSize: '10px',
                    fontWeight: 700,
              ...
              {userMenuOpen && (
                <div style={{
                  ...
                  {[
                    ...
                    { label: 'My Tunes', href: `/profile/${user.username}?tab=tunes` },
                    { label: 'Saved Tunes', href: `/profile/${user.username}?tab=saved` },
            ...
            <>
              <Link href="/login" style={{
                ...
                onMouseLeave={(e) => { const el = e.currentTarget as HTMLElement; el.style.borderColor = 'rgba(255,255,255,0.15)'; el.style.color = '#cbd5e1' }}
              >
                Sign in
              </Link>
