  ...
  return (
    ...
    >
      ...
      <section style={sectionStyle}>
        ...
        <p style={pStyle}>
          By accessing or using Tunix, you agree to be bound by these Terms. If
          you disagree with any part, you may not use the service.
        </p>
      </section>
      ...
      <section style={sectionStyle}>
        ...
        <p style={pStyle}>
          Tunix is provided &quot;as is&quot;. Tune settings are
          user-contributed and not guaranteed to work in any specific game
