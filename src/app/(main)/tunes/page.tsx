        ...
        >
            ...
            >
                ...
                <div style={{ textAlign: "right" }}>
                    ...
                    >
                        <span style={{ color: "#facc15", marginRight: "3px" }}>
                            ^
                        </span>
                        {tune.upvotes}
                    </div>
                    ...
                    <button
                        ...
                        onMouseEnter={(e) => {
                            if (game.active)
                                ...
                                ).style.borderColor = game.accent + "99"
                        }}
                        onMouseLeave={(e) => {
                            ;(
                                e.currentTarget as HTMLElement
                            ).style.borderColor = game.active
                                ? game.accent + "44"
