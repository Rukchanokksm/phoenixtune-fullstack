              ...
              >
                {CAR_CLASSES.map((cls) => {
                  ...
                  return (
                    <button
                      key={cls.id}
                      onClick={() => setCarClass(active ? "" : cls.id)}
                      style={{
                        padding: "8px 18px",
                        borderRadius: "8px",
                        fontSize: "14px",
                  ...
                  >
                    ...
                    <div style={{ maxWidth: "200px" }}>
                      <NumInput
                        ...
                        onBlur={() => setGearFinal(clamp(gearFinal, 0, 6.1, 2))}
                      />
                    </div>
                    {gearType === "full" && (
                      <>
                        <div>
                          <label style={S.label}>{st.gearCountLabel}</label>
                          <select
                            value={gearCount}
                            onChange={(e) =>
                        ...
                        >
                          {Array.from({ length: gearCount }, (_, i) => i).map(
                            (i) => (
                              <div
                                key={i}
                                style={{
                              ...
                              >
                                <NumInput
                                  ...
                                  onBlur={() =>
                                    setGear(i, clamp(gears[i], 0, 6.0, 2))
                                  }
                                />
                              </div>
                            ),
                    ...
                    <div>
                      ...
                      <div style={S.row}>
                        <NumInput
                          ...
                          step={0.1}
                          onChange={setSpF}
                          onBlur={() => setSpF(clamp(spF, 0, 9999.9, 1))}
                        />
                        <NumInput
                          label="Rear"
                          value={spR}
                          ...
                          step={0.1}
                          onChange={setSpR}
                          onBlur={() => setSpR(clamp(spR, 0, 9999.9, 1))}
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <div style={S.row}>
                        <NumInput
                          ...
                          step={0.1}
                          onChange={setRhF}
                          onBlur={() => setRhF(clamp(rhF, 0, 99.9, 1))}
                        />
                        <NumInput
                          label="Rear"
                          value={rhR}
                          ...
                          step={0.1}
                          onChange={setRhR}
                          onBlur={() => setRhR(clamp(rhR, 0, 99.9, 1))}
                        />
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div style={{ maxWidth: "160px" }}>
                        <NumInput
                          ...
                          step={1}
                          onChange={setBPre}
                          onBlur={() => setBPre(clamp(bPre, 0, 200, 0))}
                        />
                      </div>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <div style={S.row}>
                          <NumInput
                            ...
                            step={1}
                            onChange={setDAccel}
                            onBlur={() => setDAccel(clamp(dAccel, 0, 100, 0))}
                          />
                          <NumInput
                            label="Deceleration"
                            value={dDecel}
                            ...
                            step={1}
                            onChange={setDDecel}
                            onBlur={() => setDDecel(clamp(dDecel, 0, 100, 0))}
                          />
                        </div>
                      </div>
                    )}
                        ...
                        <div>
                          ...
                          <div style={S.row}>
                            <NumInput
                              ...
                              onBlur={() =>
                                setDFrontAccel(clamp(dFrontAccel, 0, 100, 0))
                              }
                            />
                            <NumInput
                              label="Deceleration"
                              ...
                              onBlur={() =>
                                setDFrontDecel(clamp(dFrontDecel, 0, 100, 0))
                              }
                            />
                          </div>
                        </div>
                        <div>
                          ...
                          <div style={S.row}>
                            <NumInput
                              ...
                              onBlur={() =>
                                setDRearAccel(clamp(dRearAccel, 0, 100, 0))
                              }
                            />
                            <NumInput
                              label="Deceleration"
                              ...
                              onBlur={() =>
                                setDRearDecel(clamp(dRearDecel, 0, 100, 0))
                              }
                            />
                          </div>
                        </div>
