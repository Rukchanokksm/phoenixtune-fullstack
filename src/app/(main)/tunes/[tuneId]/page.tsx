        ...
        tune && (
          ...
          >
            <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
              ...
              >
                {tune.user && (
                  <Avatar username={tune.user.username} size={28} />
                )}
                <span
                  style={{
                    fontSize: "13px",
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "9px",
                    border: "none",
                    background: editLoading ? "#334155" : "#facc15",
                    color: "#0d0f14",
                    fontWeight: 700,
                    fontSize: "14px",
          ...
          {!loading && tune && (
            ...
            >
              ...
              >
                ...
                {tune.game_version && (
                  <StatBox label={d.version} value={tune.game_version} />
                )}
              </div>
            </div>
          )}
