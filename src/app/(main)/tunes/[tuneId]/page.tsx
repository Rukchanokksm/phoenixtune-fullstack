...
function StatBox({ label, value }: { label: string; value: string | number }) {
    return (
        ...
        >
            <div
                style={{ fontSize: "18px", fontWeight: 800, color: "#f1f5f9" }}
            >
                {value}
            </div>
            <div
...
export default function TuneDetailPage({
    ...
    async function handleUpvote() {
        ...
        try {
            await fetch(`/api/tunes/${tuneId}/upvote`, {
        ...
        return (
            ...
            >
                <div style={{ textAlign: "center" }}>
                    ...
                    <h1 style={{ color: "#f1f5f9", marginBottom: "8px" }}>
                        {d.notFoundTitle}
                    </h1>
    ...
    const accent = tune?.game
        ...
        : "#facc15"
    const ds = tune
        ? (DISCIPLINE_STYLE[tune.discipline] ?? {
              bg: "#1e293b",
              color: "#94a3b8",
          })
        : null
                        ...
                        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
                            ...
                            >
                                ...
                                >
                                    {d.by}{" "}
                                    <Link
                                        href={`/profile/${tune.user?.username}`}
                                        style={{
                                            color: accent,
                                            textDecoration: "none",
                                            fontWeight: 600,
                                ...
                                >
                                    {timeAgoLocale(tune.created_at, locale)}
                                </span>
                                {wasEdited(
                                    tune.created_at,
                                    tune.updated_at,
                ...
                <div style={{ flex: "1", minWidth: "300px" }}>
                    {!loading && tune && (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {tune.view_count} {d.views.toLowerCase()}
                                </span>
                            </div>
                        </div>
                    )}
                    ...
                    {isEditing && tune && (
                        ...
                        >
                            ...
                            {[
                                ...
                                {
                                    label: d.shareCodeField,
                                    key: "shareCode" as const,
                                    placeholder: d.shareCodePlaceholder,
                                },
                                {
                                    label: d.gameVersionField,
                                    key: "gameVersion" as const,
                            ...
                            {/* Parameters */}
                            {getParamSections(tune.car?.drivetrain, true).map(
                                (section) => (
                                    <div
                                        key={section.title}
                    ...
                    {loading ? (
                        ...
                        tune && (
                            ...
                            >
                                {getParamSections(tune.car?.drivetrain).map(
                                    (section) => {
                ...
                <div style={{ width: "240px", flexShrink: 0 }}>
                    ...
                    {!loading && tune?.share_code && (
                        <div
                            style={{
                                background:
                                    "linear-gradient(135deg,#0f1a2a,#0d0f14)",
