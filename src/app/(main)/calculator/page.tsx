                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    set("balanceFront", Number(e.target.value))
                                }
                                style={{
                                    width: "100%",
                                    accentColor: "#facc15",
                    ...
                    {!result ? (
                        ...
                        >
                            ...
                            >
                                <span>
                                    ⚖️ Balance{" "}
                                    <strong>{form.balanceFront}% F</strong>
                                </span>
                                <span>🔧 {form.drivetrain}</span>
                                <span
                                    style={{
                                        color: DISCIPLINE.find(
                                            (d) => d.value === form.discipline,
                                        )?.color,
                                    }}
                                >
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <RideHeightBar
                                        pct={result.springs.rideHeightPct}
                                    />
                                </div>
