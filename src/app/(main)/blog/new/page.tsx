...
import { BLOG_TAGS } from "@/lib/blogTags"
        ...
        >
            ...
            >
                ...
                <div>
                            ...
                            >
                                ...
                                {block.type === "text" && (
                                    <textarea
                                        ...
                                        rows={5}
                                        placeholder={t.blog.textPlaceholder}
                                        style={{
                                            width: "100%",
                                            padding: "10px 14px",
                                            borderRadius: "8px",
                                ...
                                {block.type === "section" && (
                                    <input
                                        ...
                                        placeholder={
                                            t.blog.sectionTitlePlaceholder
                                        }
                                        style={{
                                            ...inputStyle,
                                            fontWeight: 700,
                    ...
                    >
                        {(["text", "image", "section"] as Block["type"][]).map(
                            (type) => (
                                <button
                                    key={type}
                                    type="button"
