...
export default function CarTunesPage({
  params,
}: {
  params: Promise<{ gameSlug: string; brand: string; carId: string }>;
}) {
  ...
  return (
    <div
      style={{ background: "#0d0f14", minHeight: "100vh", color: "#e2e8f0" }}
    >
      {/* Header */}
      <div style={{ borderBottom: "1px solid #1e2330", background: "#0f1117" }}>
        <div
          style={{ maxWidth: "1100px", margin: "0 auto", padding: "20px 24px" }}
        >
          {/* Breadcrumb */}
          <div
            style={{
          ...
          >
            ...
            <span>›</span>
            <Link
              href={`/games/${gameSlug}/${encodeURIComponent(brandName)}`}
              style={{ color: "#64748b", textDecoration: "none" }}
            >
              {brandName}
            </Link>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "24px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "6px" }}>
            {(["newest", "popular"] as const).map((s) => (
              <button
                key={s}
                onClick={() => handleFilter(() => setSortBy(s))}
                style={{
                  padding: "7px 16px",
                  borderRadius: "8px",
                  fontSize: "13px",
          ...
          >
            ...
            {PI_CLASSES.map((cls) => (
              <button
                key={cls || "all"}
                onClick={() => handleFilter(() => setFilterClass(cls))}
                style={{
                  padding: "5px 12px",
                  borderRadius: "6px",
                  fontSize: "12px",
                  ...
                  background:
                    filterClass === cls
                      ? (PI_COLOR[cls] ?? meta.accent) + "33"
                      : "#1a1d24",
                  color:
                    filterClass === cls
                      ? (PI_COLOR[cls] ?? meta.accent)
                      : "#64748b",
          ...
          >
            ...
            {DISCIPLINES.map((d) => {
              ...
              return (
                <button
                  key={d.id}
                  onClick={() => handleFilter(() => setFilterDiscipline(d.id))}
                  style={{
                    padding: "5px 12px",
                    borderRadius: "6px",
                    fontSize: "12px",
        ...
        {loading ? (
          ...
          >
            ...
            <p
              style={{ fontSize: "16px", margin: "0 0 8px", color: "#64748b" }}
            >
              ยังไม่มี tune สำหรับรถคันนี้
            </p>
            <p style={{ fontSize: "13px", margin: "0 0 24px" }}>
              เป็นคนแรกที่แชร์ tune!
            </p>
            <Link
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: "200px" }}>
                      ...
                      >
                        {tune.discipline &&
                          (() => {
                            const dc =
                              DISCIPLINE_COLOR[tune.discipline] ?? "#64748b";
                            return (
                              <span
                                style={{
                                  fontSize: "11px",
                    ...
                    >
                      ...
                      <div>
                        {new Date(tune.created_at).toLocaleDateString("th-TH", {
                          day: "numeric",
                          month: "short",
                          year: "2-digit",
                        })}
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                background: "#111318",
                border: "1px solid #1e2330",
                color: page === totalPages ? "#2a2f3f" : "#94a3b8",
