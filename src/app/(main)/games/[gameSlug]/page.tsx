...
> = {
    "forza-horizon-5": {
        ...
        subtitle: "Mexico Open World · 500+ Cars",
    ...
    "nfs-unbound": {
        ...
        subtitle: "Lakeshore City · Street Racing",
...
export default async function GamePage({
    ...
    // Single query: id + cover_url path (no extra storage API call)
    ...
    // Build public URL from stored path — pure string concat, zero network cost
            ...
            >
                ...
                <section>
                    <Heading
                        emoji="🏆"
                        title="Top Tunes"
                        sub="tune ที่ได้รับ upvote สูงสุดในชุมชน"
                        dot={meta.accent}
                    />
                ...
                <section>
                    <Heading
                        emoji="🧮"
                        title="Tune Lab"
                        sub="คำนวณค่า tune จากสเปครถของคุณ"
                        dot="#facc15"
                    />
                    <div
                        style={{
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                >
                                    กรอกค่า Balance, Drivetrain, Weight และ
                                    Torque ระบบจะคำนวณให้อัตโนมัติ
                                </p>
                            </div>
                            <Link
                                href="/calculator"
                ...
                {brands.length > 0 && (
                    <section>
                        <Heading
                            emoji="🚗"
                            title="Car Brands"
                            sub={`ค้นหา tune ตามยี่ห้อรถ — ${brands.length} แบรนด์`}
                            dot="#4ade80"
                        />
                        <BrandsGrid
                            gameSlug={gameSlug}
                ...
                <section>
                    <Heading
                        emoji="📋"
                        title="ดู Tune ทั้งหมด"
                        sub={`รวม tune ทุก discipline สำหรับ ${meta.name}`}
                        dot={meta.accent}
                    />
                    <Link
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                >
                                    ค้นหา กรอง และเรียงดู tune จากชุมชน — ตาม
                                    discipline, class, drivetrain และอื่นๆ
                                </p>
                            </div>
                            <div
                                style={{
