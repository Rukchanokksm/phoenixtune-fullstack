    ...
    >
      <div style={{ width: "100%", maxWidth: "400px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          >
            <span style={{ color: "#facc15", fontWeight: 700 }}>Tu</span>
            nix
          </p>
        </div>
            ...
            <div>
              ...
              <input
                style={{
                  ...inp,
                  borderColor:
                    fConfirm && fConfirm !== fNewPw ? "#f87171" : "#1e2130",
                }}
                type="password"
                placeholder="••••••••"
                value={fConfirm}
          ...
          >
            ...
            <div>
              ...
              <input
                style={{
                  ...inp,
                  borderColor: cNew && cNew === cOld ? "#f87171" : "#1e2130",
                }}
                type="password"
                placeholder="••••••••"
                value={cNew}
            ...
            <div>
              ...
              <input
                style={{
                  ...inp,
                  borderColor:
                    cConfirm && cConfirm !== cNew ? "#f87171" : "#1e2130",
                }}
                type="password"
                placeholder="••••••••"
                value={cConfirm}
