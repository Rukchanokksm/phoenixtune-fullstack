...
export default function RegisterPage() {
  ...
  async function handleSubmit(ev: React.FormEvent) {
    ...
    try {
      ...
      setServerError(err instanceof Error ? err.message : t.auth.errGeneric);
    } finally {
      setLoading(false);
    }
  }
        ...
        >
          ...
          <div>
            ...
            <input
              style={{
                ...inp,
                borderColor: errors.username ? "#f87171" : "#1e2130",
              }}
          ...
          <div>
            ...
            <input
              style={{
                ...inp,
                borderColor: errors.email ? "#f87171" : "#1e2130",
              }}
              type="email"
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              <input
                style={{
                  ...inp,
                  borderColor: errors.password ? "#f87171" : "#1e2130",
                  paddingRight: "42px",
                }}
                  ...
                  {[0, 1, 2].map((i) => (
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: "2px",
                        background:
                          i <= strength.level ? strength.color : "#1e2130",
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "9px",
              border: "none",
              background: loading ? "#64748b" : "#facc15",
              color: "#0d0f14",
              fontWeight: 800,
              fontSize: "15px",
